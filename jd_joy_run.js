...
===========Surge=================
[Script]
宠汪汪邀请助力与赛跑助力 = type=cron,cronexp="5 10,12 * * *",wake-system=1,timeout=3600,script-path=jd_joy_run.js
...
[task_local]
# 宠汪汪邀请助力与赛跑助力
5 10,12 * * * jd_joy_run.js, tag=宠汪汪邀请助力与赛跑助力, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true
[rewrite_local]
# 宠汪汪助力更新Token
...
=====================Loon=====================
[Script]
cron "5 10,12 * * *" script-path=jd_joy_run.js, tag=宠汪汪邀请助力与赛跑助力
...
//下面给出好友邀请助力的示例填写规则
let invite_pins = ['jd_7da342e378a0c,jd_551768b5ef53f'];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ['jd_7da342e378a0c,jd_551768b5ef53f'];
//friendsArr内置太多会导致IOS端部分软件重启,可PR过来(此处目的:帮别人助力可得30g狗粮)
let friendsArr = ["jd_7da342e378a0c", "jd_551768b5ef53f"]
    ...
    if (cookiesArr[i]) {
      ...
      if ($.isNode()) {
        if (process.env.JOY_RUN_HELP_MYSELF) {
          ...
          let fixPins = run_pins.splice(run_pins.indexOf('jd_7da342e378a0c'), 1);
          fixPins.push(...run_pins.splice(run_pins.indexOf('jd_551768b5ef53f'), 1));
