...
活动入口：暂无 [活动地址](https://carnivalcity.m.jd.com/#/home)

往期奖励：
a、第1名可获得实物手机一部
b、 每日第2-500名，可获得50个京豆
c、 每日第501-1000名可获得20个京豆
...
============小火箭=========
京东手机狂欢城 = type=cron,script-path=jd_carnivalcity.js, cronexpr="0 0,6,12,18 * * *", timeout=3600, enable=true
*/
...
//助力API
function toHelp(code = "d01fb794-e704-4436-b85b-894fef3212e4") {
  return new Promise(resolve => {
