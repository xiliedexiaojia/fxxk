/*
第一个号助力作者，其他号助力第一个CK
cron 16 1,8,16 * * * https://raw.githubusercontent.com/star261/jd/main/scripts/jd_vivo.js
...
!(async () => {
    ...
    let res = [];
    try{res = await getAuthorShareCode('http://cdn.boledao.com.shareCodes/vivo.json');}catch (e) {}
    if(res.length > 0){
