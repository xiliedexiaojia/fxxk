...
[task_local]
#预售福利机
5 5,20 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_ys.js, tag=预售福利机, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "5 5,20 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_ys.js,tag=预售福利机

===============Surge=================
预售福利机 = type=cron,cronexp="5 5,20 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_ys.js

============小火箭=========
预售福利机 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_ys.js, cronexpr="5 5,20 * * *", timeout=3600, enable=true
 */
const $ = new Env('预售福利机');
...
!(async () => {
  ...
  let res = await getAuthorShareCode('http://cdn.boledao.com/shareCodes/ys.json')
