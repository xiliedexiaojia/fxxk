...
let flCode =  $.isNode() ? (process.env.FLCODE3 ? process.env.FLCODE3 : 'SMIg8Yr'):'SMIg8Yr';
let cookiesArr = [];
if ($.isNode()) {
...
async function main() {
    ...
    $.UA = `jdapp;iPhone;10.3.0;14.6;${randomString(40)};M/5.0;network/wifi;ADID/;model/iPhone8,1;addressid/0;appBuild/167903;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1;`
    $.max = false;
    $.hotFlag = false;
