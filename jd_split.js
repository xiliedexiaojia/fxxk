...
[task_local]
#金榜年终奖
5 0,2 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_split.js, tag=年终奖, enabled=true

================Loon==============
[Script]
cron "5 0,2 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_split.js,tag=年终奖

===============Surge=================
金榜年终奖 = type=cron,cronexp="5 0,2 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_split.js

============小火箭=========
金榜年终奖 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_split.js, cronexpr="5 0,2 * * *", timeout=3600, enable=true
 */
const $ = new Env('金榜年终奖');
...
!(async () => {
  ...
  let res = await getAuthorShareCode('http://cdn.boledao.com/shareCodes/split.json')
