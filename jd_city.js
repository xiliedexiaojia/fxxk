...
[task_local]
#城城领现金
0 0,1-23/5 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_city.js, tag=城城领现金, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
...
const author_codes = ['-ryUXvhdZWBBNhHDQorFpM2CIUgRVyFD','-ryUXKkNYWJLMReRHN7GoZpBpnpPUs-Q'].sort(() => 0.5 - Math.random())
const self_code = []
let pool = []
!(async () => {
