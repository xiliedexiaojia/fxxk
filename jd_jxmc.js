...
async function main() {
    ...
    if(JXUserAgent){
        ...
        ua = `jdpingou;iPhone;5.7.0;14.6;${randomWord(false,40,40)};network/wifi;model/iPhone9,2;appBuild/100729;ADID/00000000-0000-0000-0000-000000000000;supportApplePay/1;hasUPPay/0;pushNoticeIsOpen/1;hasOCPay/0;supportBestPay/0;session/936;pap/JA2019_3111800;brand/apple;supportJDSHWK/1;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E200`;
    }
    token = await getJxToken();
    activeid = 'null';
