...
async function barGain() {
  let res = await getAuthorShareCode2('http://cdn.boledao.com/shareCodes/jd_barGain.json')
  ...
  for (let item of $.inBargaining) {
    ...
    const options = {
      ...
      headers: {
        ...
        'Connection': 'keep-alive',
        'Accept': 'application/json, text/plain, */*',
        'User-Agent': 'jdapp;iPhone;10.2.2;14.6;network/wifi;ADID/;supportApplePay/0;hasUPPay/0;hasOCPay/0;model/iPhone10,3;addressid/;supportBestPay/0;appBuild/167863;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1',
...
async function bigWinner() {
  let res = await getAuthorShareCode2('http://cdn.boledao.com/shareCodes/bigWinner.json')
  ...
  return new Promise(resolve => {
    $.get({
      ...
      headers: {
        ...
        'user-agent': 'jdltapp;iPhone;3.7.6;14.6;network/wifi;hasUPPay/0;pushNoticeIsOpen/0;lang/zh_CN;model/iPhone10,2;hasOCPay/0;appBuild/1095;supportBestPay/0;pv/7.0;apprpd/;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1',
        'accept-language': 'zh-cn',
