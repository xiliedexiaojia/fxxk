...
[task_local]
#东东超市
7 0,1-23/2 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_superMarket.js, tag=东东超市, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxc.png, enabled=true
===========Loon===============
[Script]
cron "7 0,1-23/2 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_superMarket.js,tag=东东超市
=======Surge===========
东东超市 = type=cron,cronexp="7 0,1-23/2 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_superMarket.js
==============小火箭=============
东东超市 = type=cron,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_superMarket.js, cronexpr="7 0,1-23/2 * * *", timeout=3600, enable=true
 */
const $ = new Env('东东超市');
...
async function barGain() {
  let res = await getAuthorShareCode2('http://cdn.boledao.com/shareCodes/jd_barGain.json'), res2 = [];
...
async function bigWinner() {
  let res = await getAuthorShareCode2('http://cdn.boledao.com/shareCodes/bigWinner.json'), res2 = [];
  if (!res) {
    res = await getAuthorShareCode2('http://cdn.boledao.com/shareCodes/bigWinner.json')
  }
  ...
  return new Promise(resolve => {
    $.get({
      ...
      headers: {
        ...
        'user-agent': 'jdltapp;iPhone;3.7.2;14.6;network/wifi;hasUPPay/0;pushNoticeIsOpen/0;lang/zh_CN;model/iPhone10,2;hasOCPay/0;appBuild/1094;supportBestPay/0;pv/7.0;apprpd/;Mozilla/5.0 (iPhone; CPU iPhone OS 14_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1',
        'accept-language': 'zh-cn',
        'referer': `https://618redpacket.jd.com/?activityId=PFbUR7wtwUcQ860Sn8WRfw&redEnvelopeId=${redEnvelopeId}&inviterId=${inviter}&helpType=1&lng=&lat=&sid=`,
        'Cookie': cookie
      }
    }, (err, resp, data) => {
      resolve()
