...
[task_local]
京东金融天天拼图
12 0,13 * * * jd_ttpt.js, tag=京东金融天天拼图, enabled=true

================Loon==============
[Script]
cron "12 0,13 * * *" script-path=jd_ttpt.js,tag=京东金融天天拼图

===============Surge=================
京东金融天天拼图 = type=cron,cronexp="12 0,13 * * *",wake-system=1,timeout=20,script-path=jd_ttpt.js

============小火箭============
京东金融天天拼图 = type=cron,script-path=jd_ttpt.js, cronexpr="12 0,13 * * *", timeout=3600, enable=true
*
*/
const $ = new Env('天天拼图');
