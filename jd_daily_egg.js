...
[task_local]
#天天提鹅
35 * * * * jd_daily_egg.js, tag=天天提鹅, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdte.png, enabled=true

================Loon==============
[Script]
cron "35 * * * *" script-path=jd_daily_egg.js,tag=天天提鹅

===============Surge=================
天天提鹅 = type=cron,cronexp="35 * * * *",wake-system=1,timeout=3600,script-path=jd_daily_egg.js

============小火箭=========
天天提鹅 = type=cron,script-path=jd_daily_egg.js, cronexpr="35 * * * *", timeout=3600, enable=true
 */
const $ = new Env('天天提鹅');
