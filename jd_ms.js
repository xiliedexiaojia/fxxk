...
[task_local]
#搞鸡玩家-秒秒币
10 7 * * * jd_ms.js, tag=搞鸡玩家-秒秒币, img-url=, enabled=true

================Loon==============
[Script]
cron "10 7 * * *" script-path=jd_ms.js, tag=搞鸡玩家-秒秒币

===============Surge=================
搞鸡玩家-秒秒币 = type=cron,cronexp="10 7 * * *",wake-system=1,timeout=3600,script-path=jd_ms.js

============小火箭=========
搞鸡玩家-秒秒币 = type=cron,script-path=jd_ms.js, cronexpr="10 7 * * *", timeout=3600, enable=true
 */
...
const UA = `jdapp;iPhone;10.3.2;14.6;${randomWord(false,40,40)};network/wifi;JDEbook/openapp.jdreader;model/iPhone9,2;addressid/0;appBuild/167922;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/16E158;supportJDSHWK/1`;
!(async () => {
  if (!cookiesArr[0]) {
