...
[task_local]
#京东资产变动通知
58 6,11,17,23 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_bean_change.js, tag=京东资产变动通知, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
================Loon===============
[Script]
cron "58 6,11,17,23 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_bean_change.js, tag=京东资产变动通知
=============Surge===========
[Script]
京东资产变动通知 = type=cron,cronexp="58 6,17,23 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_bean_change.js

============小火箭=========
京东资产变动通知 = type=cron,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_bean_change.js, cronexpr="58 6,17,23 * * *", timeout=3600, enable=true
 */
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
     ...
     // console.log(`\n********开始【京东账号${$.index}】${$.nickName || $.UserName}******\n`);
      console.log(`\n********开始【京东账号】${$.nickName.substring(0, 3).concat('***')}******\n`);
      if (!$.isLogin) {
...
async function bean() {
  ...
  for (let item of todayArr) {
    if (Number(item.amount) > 0) {
      ...
      $.todayexpenseBean += Number(item.amount);
    }
  }
