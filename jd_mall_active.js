...
if ($.isNode()) {
  ...
  actURL = process.env.ACT_URL || 'http://cdn.boledao.com/shareCodes/mall_active.json'
} else {
...
async function main(urlID,code) {
  ...
  $.UA = `jdapp;iPhone;10.2.7;14.6;${randomString(40)};M/5.0;network/wifi;ADID/;model/iPhone8,1;addressid/0;appBuild/167894;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1;`;
  $.max = false;
  $.hotFlag = false;
  $.code = code;
