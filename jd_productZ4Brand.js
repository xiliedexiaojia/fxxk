...
特务Z
脚本没有自动开卡，会尝试领取开卡奖励
cron 0,23 23 * * * https://raw.githubusercontent.com/star261/jd/main/scripts/jd_productZ4Brand.js
一天要跑2次
*/
const $ = new Env('特务Z');
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        UA = `jdapp;iPhone;10.1.4;14.6;${randomWord(false,40,40)};network/wifi;JDEbook/openapp.jdreader;model/iPhone9,2;addressid/0;appBuild/167814;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/16E158;supportJDSHWK/1`;
        $.index = i + 1;
        $.cookie = cookiesArr[i];
        $.isLogin = true;
        $.nickName = '';
